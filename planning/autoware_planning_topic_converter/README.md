...
<load_composable_node target="container_name">
  <composable_node pkg="planning_topic_converter" plugin="autoware::planning_topic_converter::PathToTrajectoryNode" name="path_to_trajectory_converter" namespace="">
  <!-- params -->
